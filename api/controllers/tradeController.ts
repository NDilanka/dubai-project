    ...
    if (request.method === "GET") {
      ...
      try {
        ...
        if (data.btc1.length === 0) {
          return new Response(JSON.stringify({message: "Please provide btc1!"}), {
            status: 400,
            headers: {"Content-Type": "application/json"}
          });
        }
        ...
        if (data.btc2.length === 0) {
          return new Response(JSON.stringify({message: "Please provide btc2!"}), {
            status: 400,
            headers: {"Content-Type": "application/json"}
          });
        }
        ...
        if (data.btc3.length === 0) {
          return new Response(JSON.stringify({message: "Please provide btc3!"}), {
            status: 400,
            headers: {"Content-Type": "application/json"}
          });
        }
        ...
        if (data.btc4.length === 0) {
          return new Response(JSON.stringify({message: "Please provide btc4!"}), {
            status: 400,
            headers: {"Content-Type": "application/json"}
          });
        }
        ...
        if (data.btc5.length === 0) {
          return new Response(JSON.stringify({message: "Please provide btc5!"}), {
            status: 400,
            headers: {"Content-Type": "application/json"}
          });
        }
        ...
        if (!data.amount) {
          return new Response(JSON.stringify({message: "Please provide the amount"}), {
            status: 400,
            headers: {"Content-Type": "application/json"}
          });
        }
        ...
        */
        ...
        const result = await db.collection("trades").updateOne({ _id: new ObjectId(data.id) }, {
          $set: {
            btc1: data.btc1,
            btc2: data.btc2,
            btc3: data.btc3,
        ...
        if (result.modifiedCount === 1) {
          return new Response(JSON.stringify({message: "Trade updated successfully!"}), {
            status: 200,
            headers: {"Content-Type": "application/json"}
          });
        }
